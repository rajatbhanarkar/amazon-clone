...
function Header() {
    return (
        <div className="header">
            <img className="header_logo" src="https://mikekitko.com/wp-content/uploads/2019/10/amazon-logo-white.png" alt="Amazon"/>
            <div className="header_select_location">
                <div className="header_select_location_icon">
                    <LocationOnOutlinedIcon />
                </div>
                <div className="header_select_location_text">
                    <p>Hello</p>
